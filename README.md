...
5. Ejecutamos jenkins como contenedor Docker exponiéndolo en el puerto 8080 del ordenador local:
...
6. Verificamos que se pueda ingresar al contenedor a través del navegador web de preferencia.
...
7. Cancelamos la ejecución actual y ahora hazlo asignando un volumen dentro del ordenador local para guardar las configuraciones que hagamos en la herramienta y no se pierdan a medida que ejecutamos el contenedor.
